...
const reviews = [
  { name: "Alex R.", game: "CS2", quote: "Went from 800 ELO to 2500 in 2 days. Absolutely insane service! The PRO was super professional and communicated the whole time.", rating: 5, orders: "12 orders" },
  { name: "Maria K.", game: "Dota 2", quote: "Got from 3k to 5.5k MMR in a week. Account was completely safe the whole time. Best marketplace I've ever used.", rating: 5, orders: "8 orders" },
  { name: "Jake T.", game: "Rust", quote: "Best resource delivery ever. Logged in to stacks of sulfur and stone. Will definitely come back every wipe.", rating: 5, orders: "5 orders" },
  { name: "Sarah L.", game: "Arena Breakout", quote: "The raid sessions are amazing. Extracted with millions in loot. These guys know every map inside out.", rating: 5, orders: "3 orders" },
  { name: "Mike D.", game: "CS2", quote: "Rank service was incredibly fast. Went from Level 5 to Level 10 in two days. Worth every penny.", rating: 5, orders: "6 orders" },
  ...
  { name: "Lisa M.", game: "Arena Breakout", quote: "Koens delivery is legit. Got 50M overnight. No issues at all. Customer support is top notch too.", rating: 5, orders: "9 orders" },
];
