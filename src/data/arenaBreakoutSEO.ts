...
export const arenaBreakoutSEO: Record<string, ServiceSEO> = {
  "koens-farming": {
    ...
    metaDescription: "Buy Arena Breakout: Infinite Koens farming service. Professional boosters deliver 1M+ Koens fast. Secure, affordable, 24/7 support.",
    ...
    content: `
      ...
      <h2>Why Choose Our Arena Breakout: Infinite Boosting Service?</h2>
      <p>Our Arena Breakout: Infinite boosting team consists of elite players who have mastered every map, loot route, and extraction point. When you buy Arena Breakout boost from us, you're getting more than just currency—you're getting peace of mind. We use VPN protection, play during your normal hours, and never use any prohibited software. Your account safety is our top priority.</p>

      <h2>Fast Koens Delivery</h2>
      <p>Time is money, and we respect both. Our Arena Breakout boosting service delivers 1M Koens in just 1-2 hours on average. Need more? We can farm up to 500M Koens with our scalable service. Every booster is vetted, experienced, and focused on maximizing efficiency without compromising your account security.</p>

      <h2>How Our Arena Breakout Boost Works</h2>
      ...
      <p>Questions? Our support team is available around the clock to assist you. Every Arena Breakout: Infinite boosting order comes with a satisfaction guarantee. If you're not happy, we'll make it right. Join thousands of satisfied customers who trust us for their Arena Breakout boost needs.</p>
    `
  },
  "raids-boost": {
    metaTitle: "Arena Breakout: Infinite Raids Boost | Professional Raid Carry Service",
    metaDescription: "Buy Arena Breakout: Infinite raids boost. Expert carries on all maps including Lockdown and Forbidden modes. VIP extraction guaranteed.",
    ...
    content: `
      ...
      <h2>Expert Arena Breakout: Infinite Boosting on All Maps</h2>
      ...
      <p>Need just one raid or planning a marathon session? Our Arena Breakout: Infinite boosting service offers packages from 1 to 20 raids. Each raid is completed in 30-60 minutes on average, and you can mix and match maps and modes to suit your goals. Buy Arena Breakout boost today and start dominating the battlefield.</p>
    `
  },
  "titanium-case": {
    metaTitle: "Arena Breakout: Infinite Titanium 3x3 Case | Premium Loot Boost",
    metaDescription: "Buy Arena Breakout: Infinite Titanium 3x3 Case service. Guaranteed top-tier loot delivery in 24-48 hours. Premium boosting service.",
    ...
    content: `
      ...
      <p>Our Arena Breakout: Infinite boosting team ensures that every Titanium Case delivery includes premium weapons, rare attachments, valuable medical supplies, and high-tier armor. No randomness, no disappointment—just guaranteed quality loot that's ready to use the moment it arrives in your stash.</p>

      <h2>Safe & Secure Delivery</h2>
      <p>Account security is paramount when you buy Arena Breakout boost from us. We use industry-standard VPN protection, operate during your normal play hours, and never use any third-party software that could flag your account. Your Titanium Case will be delivered discreetly and safely, with full support throughout the process.</p>

      <h2>Premium Service, Premium Results</h2>
      <p>This is our flagship Arena Breakout: Infinite boosting package for players who want the best. With 24/7 customer support, progress tracking, and a satisfaction guarantee, you can trust that your investment will pay off. Join hundreds of satisfied customers who have upgraded their Arsenal with our Titanium Case service.</p>
    `
  },
  "coaching": {
    metaTitle: "Arena Breakout: Infinite Coaching | Learn From Pro Players",
    metaDescription: "Buy Arena Breakout: Infinite coaching service. Learn maps, rotations, PvP tactics from top players. Personalized 1-on-1 sessions.",
  ...
  "rent-a-booster": {
    ...
    metaDescription: "Rent a booster for Arena Breakout: Infinite. Play alongside elite players in raids. Instant start, $8.50/hour. Professional boosting service.",
