    ...
    services: [
      {
        id: "premier-rating",
        name: "Premier Rating",
        description: "Boost your CS2 Premier Rating with skilled players.",
        bullets: ["Up to 21k ELO rating", "Many games with high KD", "Choose the number of pros"],
        tag: "Popular",
        image: "/service-images/cs2/premier-rating.png",
        startPrice: "From $31.07",
        type: "slider",
        unit: "k rating",
        min: 1,
        max: 21,
      ...
      },
      {
        id: "rent-a-booster",
        name: "Rent a Booster",
        description: "Hire a professional CS2 booster for an hourly session.",
        bullets: ["Hourly gaming session", "Any in-game activities", "Up to 4 professionals"],
        tag: "Save 30%",
        image: "/service-images/cs2/rent-a-booster.png",
        startPrice: "From $17.54",
        type: "slider",
        unit: "hours",
        min: 1,
        max: 24,
      ...
      },
      {
        ...
        tag: "Save 20%",
        image: "/service-images/cs2/faceit-wins.png",
      ...
      },
      {
        id: "faceit-rank",
        name: "FACEIT Rank",
        description: "Boost your FACEIT level safely and quickly.",
        bullets: ["Both ELO and level boost", "Many games with high KD", "Customizable offer"],
        image: "/service-images/cs2/faceit-rank.png",
        startPrice: "From $20.05",
        type: "slider",
        unit: "levels",
        min: 1,
        max: 10,
      ...
      },
      {
        ...
        image: "/service-images/cs2/esea-rank.png",
        startPrice: "From $17.04",
        type: "slider",
        unit: "rank ups",
        min: 1,
        max: 10,
      ...
      },
      {
        ...
        image: "/service-images/cs2/competitive-rank.png",
        startPrice: "From $9.01",
        type: "slider",
        unit: "rank ups",
        min: 1,
        max: 18,
      ...
      },
      {
        id: "wingman-rank",
        name: "Wingman Rank",
        description: "Boost your CS2 Wingman rank with reliable players.",
        bullets: ["Any desired wingman rank", "Many games with high KD", "Add extra wins"],
        image: "/service-images/cs2/wingman-rank.png",
        startPrice: "From $30.07",
        type: "slider",
        unit: "rank ups",
        min: 1,
        max: 18,
      ...
      },
      {
        ...
        image: "/service-images/cs2/placement-matches.png",
        startPrice: "From $5.26",
        type: "slider",
        unit: "matches",
        min: 1,
        max: 10,
      ...
      },
      {
        ...
        image: "/service-images/cs2/wins-boost.png",
        startPrice: "From $3.00",
        type: "slider",
        unit: "wins",
        min: 1,
        max: 50,
      ...
      },
      {
        ...
        tag: "New",
        image: "/service-images/cs2/armory-boost.png",
        startPrice: "From $6.52",
        type: "slider",
        unit: "credits",
        min: 1,
        max: 40,
      ...
      },
      {
        id: "profile-rank",
        name: "Profile Rank",
        description: "Boost your CS2 profile rank and unlock rewards.",
        bullets: ["Up to 40 military ranks", "Many games with high KD", "Chance to get Service Medal"],
        image: "/service-images/cs2/profile-rank.png",
        startPrice: "From $86.19",
        type: "slider",
        unit: "ranks",
        min: 1,
        max: 40,
      ...
      },
      {
        ...
        image: "/service-images/cs2/coaching.png",
        startPrice: "From $30.07",
        type: "slider",
        unit: "hours",
        min: 1,
      ...
      },
      {
        ...
        bullets: ["Get up to 5 wins", "All games with high KD", "Available for all levels"],
        image: "/service-images/cs2/esea-wins.png",
        startPrice: "From $3.00",
        type: "slider",
        unit: "wins",
        min: 1,
      ...
      },
      {
        ...
        tag: "Premium",
        image: "/service-images/cs2/global-elite-boost.png",
        startPrice: "From $268.63",
        type: "fixed",
        fixedPrice: 268.63,
