...
import { Award, CheckCircle, Star, Zap, Shield, Clock, TrendingUp, Users, Target, Trophy, ShoppingCart } from "lucide-react";
          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-5xl">
              <div className="grid gap-8 lg:grid-cols-[1fr_400px]">
                {/* IMAGE: dota2-rank-tokens-service.jpg - Replace this div with <img> */}
                <div className="service-image-placeholder rounded-2xl border border-border/50 bg-secondary/30 overflow-hidden" data-image="dota2-rank-tokens-service.jpg">
                ...
                <div className="rounded-2xl border-2 border-primary/30 bg-card p-6 shadow-[0_0_30px_hsl(48_100%_50%_/_0.15)]">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">
                    Select the number of rank tokens you need
                  </p>
                  ...
                  <div className="mt-6 space-y-4">
                    <div>
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">1-100 tokens available</p>
                    </div>

                    <div className="rounded-xl border border-border/50 bg-secondary/30 p-4">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-muted-foreground">Price per token:</span>
                        <span className="font-bold text-foreground">${pricePerToken}</span>
                      </div>
